...
# NOTE - Coloque no menu a opção de calcular a esquação do 2º grau
# NOTE - Fsça usando oconceito de módulo recém -ensinado, usando o comando 'import equacoes' no main.py 
"""
